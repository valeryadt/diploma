...
<template>
  <svg width="1em" height="1em" viewBox="0 0 50 50">
    ...
    <path fill="currentColor" d="m32.283 16.302l1.414 1.415l-15.98 15.98l-1.414-1.414z"></path>
    <path fill="currentColor" d="m17.717 16.302l15.98 15.98l-1.414 1.415l-15.98-15.98z"></path>
  </svg>
</template>
